...
const sectionsFr = [
  { icon: "Building2", id: "editeur", short: "Éditeur", title: "Éditeur du site", content: ["Le site switzerit.com est édité par :", "SwitzerIT SNC", "Forme juridique : Société en nom collectif (SNC)", "Siège social : Route de Villars 15, 1867 Ollon VD, Suisse", "Numéro IDE : CHE-303.877.142", "Numéro CH-ID : CH-550-1255758-8", "Email : contact@switzerit.com", "Téléphone : +41 77 991 38 73"] },
  { icon: "Server", id: "hebergement", short: "Hébergement", title: "Hébergement", content: ["Le site est hébergé par :", "Vercel Inc.", "440 N Barranca Ave #4133, Covina, CA 91723, États-Unis", "Site web : https://vercel.com"] },
  { icon: "ShieldCheck", id: "propriete", short: "Propriété", title: "Propriété intellectuelle", content: ["La structure globale, le code, les textes, illustrations et éléments graphiques intégrés à ce site sont la propriété exclusive de SwitzerIT SNC.", "Toute reproduction, partielle ou totale du contenu de ce site, par quelque méthode que ce soit, sans l'autorisation préalable écrite de SwitzerIT SNC est strictement interdite et constitue une violation de la Loi fédérale sur le droit d'auteur (LDA, RS 231.1).", "La copie à usage strictement privé est tolérée conformément à l'article 19 LDA. Toute reproduction à des fins commerciales ou publiques sans accord écrit de SwitzerIT SNC est totalement interdite."] },
  { icon: "Link2", id: "liens", short: "Liens", title: "Liens hypertextes", content: ["Le site switzerit.com peut contenir des liens vers des sites tiers. SwitzerIT SNC ne contrôle pas ces sites et décline toute responsabilité quant à leur contenu, leurs pratiques en matière de confidentialité ou leur disponibilité.", "La création de liens vers le site switzerit.com est autorisée sans accord préalable, à condition que le lien ne soit pas trompeur et ne porte pas atteinte à l'image de SwitzerIT SNC."] },
  { icon: "AlertCircle", id: "responsabilite", short: "Responsabilité", title: "Limitation de responsabilité", content: ["SwitzerIT SNC s'efforce d'assurer l'exactitude et la mise à jour des informations diffusées sur ce site. Toutefois, elle ne peut garantir l'exactitude, la précision ou l'exhaustivité des informations mises à disposition.", "SwitzerIT SNC se réserve le droit de corriger, à tout moment et sans préavis, le contenu de ce site. Elle ne saurait être tenue responsable des dommages directs ou indirects résultant de l'utilisation de ce site."] },
  { icon: "Scale", id: "droit", short: "Droit", title: "Droit applicable", content: ["Les présentes mentions légales sont soumises au droit suisse. En cas de litige, et à défaut de résolution amiable, les tribunaux compétents du Canton de Vaud seront seuls compétents."] },
  { icon: "Mail", id: "contact", short: "Contact", title: "Contact", content: ["Pour toute question relative aux présentes mentions légales, vous pouvez nous contacter :", "Par email : contact@switzerit.com", "Par téléphone : +41 77 991 38 73", "Par courrier : SwitzerIT SNC, Route de Villars 15, 1867 Ollon VD, Suisse"] },
];

const sectionsEn = [
  { icon: "Building2", id: "publisher", short: "Publisher", title: "Website Publisher", content: ["The website switzerit.com is published by:", "SwitzerIT SNC", "Legal form: General Partnership (Société en nom collectif)", "Registered office: Route de Villars 15, 1867 Ollon VD, Switzerland", "IDE Number: CHE-303.877.142", "CH-ID Number: CH-550-1255758-8", "Email: contact@switzerit.com", "Phone: +41 77 991 38 73"] },
  { icon: "Server", id: "hosting", short: "Hosting", title: "Hosting", content: ["The website is hosted by:", "Vercel Inc.", "440 N Barranca Ave #4133, Covina, CA 91723, United States", "Website: https://vercel.com"] },
  { icon: "ShieldCheck", id: "ip", short: "IP Rights", title: "Intellectual Property", content: ["The overall structure, code, texts, illustrations and graphic elements integrated into this website are the exclusive property of SwitzerIT SNC.", "Any partial or total reproduction of the content of this website, by any method whatsoever, without the prior written authorisation of SwitzerIT SNC is strictly prohibited and constitutes a violation of the Federal Act on Copyright (CopA, RS 231.1).", "Copying for strictly private use is permitted under Article 19 CopA. Any reproduction for commercial or public purposes without written consent from SwitzerIT SNC is strictly prohibited."] },
  { icon: "Link2", id: "links", short: "Links", title: "Hyperlinks", content: ["The switzerit.com website may contain links to third-party websites. SwitzerIT SNC does not control these sites and accepts no responsibility for their content, privacy practices or availability.", "Linking to the switzerit.com website is permitted without prior agreement, provided that the link is not misleading and does not damage the image of SwitzerIT SNC."] },
  { icon: "AlertCircle", id: "liability", short: "Liability", title: "Limitation of Liability", content: ["SwitzerIT SNC endeavours to ensure the accuracy and currency of the information published on this website. However, it cannot guarantee the accuracy, precision or completeness of the information made available.", "SwitzerIT SNC reserves the right to correct, at any time and without notice, the content of this website. It cannot be held liable for direct or indirect damages resulting from the use of this website."] },
  { icon: "Scale", id: "law", short: "Law", title: "Applicable Law", content: ["These legal notices are governed by Swiss law. In the event of a dispute, and failing an amicable resolution, the competent courts of the Canton of Vaud shall have sole jurisdiction."] },
  { icon: "Mail", id: "contact", short: "Contact", title: "Contact", content: ["For any questions regarding these legal notices, you can contact us:", "By email: contact@switzerit.com", "By phone: +41 77 991 38 73", "By post: SwitzerIT SNC, Route de Villars 15, 1867 Ollon VD, Switzerland"] },
];
