...
const sectionsFr = [
  ...
  { icon: "ShieldCheck", id: "propriete", title: "Propriété intellectuelle", content: ["L'ensemble du contenu de ce site (textes, images, graphismes, logo, icônes, sons, logiciels, etc.) est la propriété exclusive de SwitzerIT SNC, sauf mention contraire.", "Toute reproduction, représentation, modification, publication, adaptation ou exploitation, totale ou partielle, de ce site ou de son contenu, par quelque procédé que ce soit, est strictement interdite sans l'autorisation préalable et écrite de SwitzerIT SNC.", "Toute violation de ces dispositions peut entraîner des poursuites civiles et pénales."] },
